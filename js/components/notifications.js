...
export const initNotifications = () => {
    ...
    if (!isNotifWindowListenerAttached) {
        window.addEventListener('click', (e) => {
            const b = document.getElementById('notification_btn');
            const d = document.getElementById('notification_dropdown');
            if (b && d && !b.contains(e.target) && !d.contains(e.target)) {
                d.classList.add('hidden');
            }
        });
        isNotifWindowListenerAttached = true;
    }
...
let isNotifWindowListenerAttached = false;
